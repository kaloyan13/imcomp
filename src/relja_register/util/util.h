...
namespace util {
    ...
    */
	...
	// updated by Abhishek Dutta <adutta@robots.ox.ac.uk>, Oct. 2017.
	inline std::string getTempFileWB(FILE *&f, std::string tmpDir = "", std::string prefix = "", std::string suffix = "", bool closeFile = false) {
		f = std::tmpfile();
    ...
    */
	// updated by Abhishek Dutta <adutta@robots.ox.ac.uk>, Oct. 2017.
	inline std::string getTempFileName(std::string tmpDir = "", std::string prefix = "", std::string suffix = "") {
		std::string tmp_fn(std::tmpnam(nullptr));
		return tmp_fn;
	}
