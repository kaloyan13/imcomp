...
|                                                               |     |                                                |
| GET /imcomp/imcomp.js                                         | --> | respond with imcomp static resource            |
| GET /imcomp/imcomp.css                                        |     |                                                |
| GET /imcomp/*.*                                               |     |                                                |
|                                                               |     |                                                |
| GET /imcomp/traherne/traherne.js                              | --> | respond with traherne static resource          |
| GET /imcomp/traherne/traherne.css                             |     |                                                |
| GET /imcomp/traherne/*.*                                      |     |                                                |
|                                                               |     |                                                |
